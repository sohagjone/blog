      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
              <a class= "col-lg-offset-6 btn btn-success" href="{{route('permission.create')}}">Add New</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-info" href="{{route('permission.edit', $permission->id)}}">Edit</a></td>
