      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
              <a class= "col-lg-offset-6 btn btn-success" href="{{route('role.create')}}">Add Role</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <form action="{{route('role.destroy', $role->id)}}" style="display:none" id="delete-form-{{$role->id}}" method="post">
                    {{ @csrf_field() }}
                    {{ method_field('DELETE') }}
                    </form>
